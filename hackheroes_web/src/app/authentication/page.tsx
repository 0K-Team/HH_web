    ...
    return (
        <>
            <section className="flex justify-center items-center bg-[#1E1E1E] min-h-screen">
                ...
                <div className="absolute w-[55vh] h-[55vh] bg-[#29FF77] opacity-10 rounded-full bottom-2 right-2 blur-3xl"></div>
                ...
                <div
                    ...
                    <Link href="/authentication/google-login"
                          className="block text-lg font-semibold text-center text-black bg-[#29FF77] py-3 rounded-full mb-6 transition duration-300 ease-in-out transform hover:bg-[#22cc66] hover:scale-105 hover:text-white shadow-lg">
                        Google
                    </Link>

                    <Link href="/authentication/meta-login"
                          className="block text-lg font-semibold text-center text-black bg-[#29FF77] py-3 rounded-full transition duration-300 ease-in-out transform hover:bg-[#22cc66] hover:scale-105 hover:text-white shadow-lg">
                        Meta (Facebook)
                    </Link>
                </div>
            </section>
