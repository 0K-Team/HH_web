...
export default function Sidebar() {
    ...
    return (
        <div
            ...
            className={`fixed top-0 left-0 h-full bg-gray-light text-white transition-all duration-500 ${isSidebarOpen ? "w-48" : "w-20"} flex flex-col items-start p-4 z-50 shadow-lg`}
        >
            <nav className="flex flex-col space-y-4 mt-10">
                ...
                <Link href="../dash">
                    <button className="flex items-center p-3 rounded-lg bg-gray-light hover:bg-gray-300 transition-all text-green-green hover:shadow-lg w-full">
                        ...
                        {isSidebarOpen && <span className="ml-4 font-bold">Panel użytkownika</span>}
                    </button>
                </Link>
