            ...
            <main className="flex flex-col flex-grow container mx-auto px-4 py-4 pt-[2vh] bg-gray-light rounded-2xl w-[60%]">
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                    <div className="bg-gray-dark rounded-lg h-[15vh] flex items-center justify-center">
                        <Link href="/not-web" className="bg-gray-dark p-6 text-green-green rounded-lg text-center h-[15vh] flex flex-col items-center justify-center">
                            <FontAwesomeIcon icon={faTree} className="text-3xl text-green-green"/>
                            <p className="font-bold text-xl">Wirtualny ogródek</p>
                        </Link>
                    </div>
                    <div className="bg-gray-dark rounded-lg h-[15vh] flex items-center justify-center">
                        <Link href="/calculator" className="p-6 rounded-lg text-green-green flex flex-col items-center justify-center">
