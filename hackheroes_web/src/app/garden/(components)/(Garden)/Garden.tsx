        ...
        <div>
            <div className="p-6 grid grid-cols-3 gap-4">
                {gardenData.plants.map((plant: Plant) => (
                    ...
                    <div key={plant._id} className=" mb-10 drop-shadow-lg text-green-green rounded bg-gray-dark pt-8 w-full m-0 flex flex-col items-center jusitfy-center h-full">
                        <Image
